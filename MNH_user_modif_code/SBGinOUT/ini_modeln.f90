...
USE MODD_BIKHARDT_n
USE MODD_BLANK_n, only:TDUMMY1,TDUMMY2,TDUMMY3,TDUMMY4,TDUMMY5,TDUMMY6,TDUMMY7,TDUMMY8, &
			TDUMMY9,TDUMMY10,TDUMMY11,TDUMMY12,TDUMMY13,TDUMMY14,TDUMMY15
USE MODD_BLOWSNOW
USE MODD_BLOWSNOW_n
USE MODD_BUDGET
...
USE MODD_FIRE_n
!
USE MODD_DIMPHYEX,         ONLY: DIMPHYEX_t ! Hugo jacquet : for vertical tracer flux
!
IMPLICIT NONE
!
...
INTEGER,          INTENT(IN)   :: KMI       ! Model Index
TYPE(TFILEDATA),  INTENT(IN)   :: TPINIFILE ! Initial file
TYPE(DIMPHYEX_t)	:: D    ! Hugo Jacquet : for vertical tracer flux
!
...
!
ALLOCATE(TDUMMY1(IIU,IJU,IKU)); TDUMMY1 = 1.0
ALLOCATE(TDUMMY2(IIU,IJU,IKU)); TDUMMY2 = 1.0
ALLOCATE(TDUMMY3(IIU,IJU,IKU)); TDUMMY3 = 1.0
ALLOCATE(TDUMMY4(IIU,IJU,IKU)); TDUMMY4 = 1.0
ALLOCATE(TDUMMY5(IIU,IJU,IKU)); TDUMMY5 = 1.0
ALLOCATE(TDUMMY6(IIU,IJU,IKU)); TDUMMY6 = 1.0
ALLOCATE(TDUMMY7(IIU,IJU,IKU)); TDUMMY7 = 1.0
ALLOCATE(TDUMMY8(IIU,IJU,IKU)); TDUMMY8 = 1.0
ALLOCATE(TDUMMY9(IIU,IJU,IKU)); TDUMMY9 = 1.0
ALLOCATE(TDUMMY10(IIU,IJU,IKU)); TDUMMY10 = 1.0
ALLOCATE(TDUMMY11(IIU,IJU,IKU)); TDUMMY11 = 1.0
ALLOCATE(TDUMMY12(IIU,IJU,IKU,4)); TDUMMY12 = 1.0 ! 4 is for the 4 CS tracers, Hugo Jacquet
ALLOCATE(TDUMMY13(IIU,IJU,IKU,3)); TDUMMY13 = 1.0
ALLOCATE(TDUMMY14(IIU,IJU,IKU,3)); TDUMMY14 = 1.0
ALLOCATE(TDUMMY15(IIU,IJU,IKU,3)); TDUMMY15 = 1.0
!
IF (LMEAN_FIELD) THEN
!
  MEAN_COUNT = 0
