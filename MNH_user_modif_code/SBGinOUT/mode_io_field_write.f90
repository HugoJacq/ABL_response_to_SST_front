...
USE MODD_BLANK_n,      ONLY: TDUMMY1, TDUMMY2, TDUMMY3,TDUMMY4,TDUMMY5,TDUMMY6,&
				TDUMMY7,TDUMMY8,TDUMMY9,TDUMMY10,TDUMMY11,TDUMMY12,&
				TDUMMY13,TDUMMY14,TDUMMY15
USE MODD_NSV,           ONLY: NSV_CSBEG,NSV_CSEND
USE MODD_FIELD_n,       ONLY: XSVT
!
IMPLICIT NONE
!
TYPE(TOUTBAK),    INTENT(IN)  :: TPOUTPUT !Output structure
...
TZFIELD = TFIELDMETADATA(                                           &
   ...
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY1)
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'LM',                                               &
   CSTDNAME   = '',                                                 &
   ...
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )  
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY2)
...
TZFIELD = TFIELDMETADATA(                                           &
   ...
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY4)
!
! Look at mode_turb_ver_thermo_corr.f90 for vertical part
! 	  mode_turb_hor_thermo_corr.f90 for horizontal part
!TZFIELD = TFIELDMETADATA(                                                &
!   CMNHNAME   = 'R_VAR',                                                 &
!   CSTDNAME   = '',                                                      &
!   CLONGNAME  = 'R_VAR',                                                 &
!   CUNITS     = 'kg2 kg-2',                                              &
!   CDIR       = 'XY',                                           	 &
!   CCOMMENT   = 'X_Y_Z_R_VAR', 				                 &
!   NGRID      = 1,                                                	 &
!   NTYPE      = TYPEREAL,                                          	 &
!   NDIMS      = 3,                                                 	 &
!   LTIMEDEP   = .TRUE.                                                   )   
!CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY18+TDUMMY19) 
!
! Look at mode_turb_ver_thermo_corr.f90 for vertical part
! 	  mode_turb_hor_thermo_corr.f90 for horizontal part
!TZFIELD = TFIELDMETADATA(                                                &
...
!   CUNITS     = 'kg2 kg-2',                                              &
!   CDIR       = 'XY',                                           	 &
!   CCOMMENT   = 'X_Y_Z_THL_VAR', 				         &
!   NGRID      = 1,                                                	 &
!   NTYPE      = TYPEREAL,                                          	 &
!   NDIMS      = 3,                                                 	 &
!   LTIMEDEP   = .TRUE.                                                   )   
!CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY20+TDUMMY21) 
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'SVT001',                                           &
   CSTDNAME   = '',                                                 &
   ...
   CUNITS     = 'kg kg-1',                                          &
   CDIR       = 'XY',                                               &
   CCOMMENT   = 'X_Y_Z_SVT001',                                     &
   NGRID      = 1,                                                  &
   NTYPE      = TYPEREAL,                                           &
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,XSVT(:,:,:,NSV_CSBEG))
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'SVT003',                                           &
   CSTDNAME   = '',                                                 &
   ...
   CUNITS     = 'kg kg-1',                                          &
   CDIR       = 'XY',                                               &
   CCOMMENT   = 'X_Y_Z_SVT003',                                     &
   NGRID      = 1,                                                  &
   NTYPE      = TYPEREAL,                                           &
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,XSVT(:,:,:,NSV_CSBEG+2))
!
IF (NSV_CSEND==NSV_CSBEG+3) THEN
	TZFIELD = TFIELDMETADATA(                                          & 
		CMNHNAME   = 'SVT004',                                          &
		CSTDNAME   = '',                                                &
		CLONGNAME  = 'SVT004',                                          &
		CUNITS     = 'kg kg-1',                                         &
		CDIR       = 'XY',                                              &
		CCOMMENT   = 'X_Y_Z_SVT004',                                    &
		NGRID      = 1,                                                 &
		NTYPE      = TYPEREAL,                                          &
		NDIMS      = 3,                                                 &
		LTIMEDEP   = .TRUE.                                             )   
	CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,XSVT(:,:,:,NSV_CSBEG+3))
ENDIF
!
! --------
! DYNAMICS
...
TZFIELD = TFIELDMETADATA(                                         &
   ...
   NDIMS      = 3,                                                &
   LTIMEDEP   = .TRUE.                                            )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY6)
!
TZFIELD = TFIELDMETADATA(                                         &
   CMNHNAME   = 'V_VAR',                                          &
   CSTDNAME   = '',                                               &
   ...
   NDIMS      = 3,                                                &
   LTIMEDEP   = .TRUE.                                            )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY7)
!
TZFIELD = TFIELDMETADATA(                                         &
   CMNHNAME   = 'W_VAR',                                          &
   CSTDNAME   = '',                                               &
   ...
   NDIMS      = 3,                                                &
   LTIMEDEP   = .TRUE.                                            )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY8)
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'VW_VFLX',                                          &
   CSTDNAME   = '',                                                 &
   ...
   CUNITS     = 'm2 s-2',                                           &
   CDIR       = 'XY',                                               &
   CCOMMENT   = 'X_Y_Z_VW_VFLX',                                    &
   NGRID      = 4,                                                  &
   NTYPE      = TYPEREAL,                                           &
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY11)
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'VW_HFLX',                                          &
   CSTDNAME   = '',                                                 &
   ...
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY9)
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'UW_VFLX',                                          &
   CSTDNAME   = '',                                                 &
   ...
   CUNITS     = 'm2 s-2',                                           &
   CDIR       = 'XY',                                               &
   CCOMMENT   = 'X_Y_Z_UW_VFLX',                                    &
   NGRID      = 4,                                                  &
   NTYPE      = TYPEREAL,                                           &
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY10)
!
TZFIELD = TFIELDMETADATA(                                           &
   CMNHNAME   = 'UW_HFLX',                                          &
   CSTDNAME   = '',                                                 &
   ...
   NDIMS      = 3,                                                  &
   LTIMEDEP   = .TRUE.                                              )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY3)
!
TZFIELD = TFIELDMETADATA(                                          &
   CMNHNAME   = 'UV_FLX',                                          &
   CSTDNAME   = '',                                                &
   ...
   NDIMS      = 3,                                                 &
   LTIMEDEP   = .TRUE.                                             )   
CALL IO_Field_write(TPOUTPUT%TFILE,TZFIELD,TDUMMY5)
!
