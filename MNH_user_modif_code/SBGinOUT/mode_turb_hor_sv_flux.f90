...
USE MODD_BLANK_n, ONLY : TDUMMY14,TDUMMY15 ! used for sbg u'sv' and v'sv' in OUT files HUGO JACQUET 
!
IMPLICIT NONE
!
!
...
! the IKB flux gives the ground value
  ...
  !
  IF (JSV==NSV_CSBEG) THEN ! Hugo Jacquet : save subgrid u'sv' in OUT files
   	TDUMMY14(:,:,:,1) = ZFLXX
